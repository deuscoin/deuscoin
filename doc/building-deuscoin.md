...
Follow the setup for Ubuntu in Virtualbox as described in the [Bitcoin Documentation](gitian-building.md)
...
Now we'll be following the [Bitcoin Release Process](release-process.md) loosely. Make the directory we'll be downloading everything to.

...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("deuscoin.sipa.be", "seed.deuscoin.sipa.be"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "dnsseed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed.deuscoin.dashjr.org"));
        vSeeds.push_back(CDNSSeedData("deuscoinstats.com", "seed.deuscoinstats.com"));

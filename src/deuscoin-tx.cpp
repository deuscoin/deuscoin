...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Deuscoin Core deuscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  deuscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded deuscoin transaction") + "\n" +
              "  deuscoin-tx [options] -create [commands]   " + _("Create hex-encoded deuscoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded deuscoin transaction

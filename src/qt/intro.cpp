...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/deuscoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Deuscoin Core"),
     ...
     * override -datadir in the deuscoin.conf file in the default data directory
     * (to be consistent with deuscoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())

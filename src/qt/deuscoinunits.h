...
#ifndef DEUSCOINUNITS_H
#define DEUSCOINUNITS_H
...
/** Deuscoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DeuscoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DeuscoinUnits(QObject *parent);
...
typedef DeuscoinUnits::Unit DeuscoinUnit;

#endif // DEUSCOINUNITS_H

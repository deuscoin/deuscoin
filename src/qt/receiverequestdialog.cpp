...
#include "config/deuscoin-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatDeuscoinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + DeuscoinUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatDeuscoinURI(info));
}
